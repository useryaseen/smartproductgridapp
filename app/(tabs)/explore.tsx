  ...
  return (
    <ScrollView style={[styles.page, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
        ...
        <Text style={[styles.p, { color: colors.mutedText }]}>
          Category edits are simulated locally with delay and random failures. External updates only change price/rating
          so they don’t overwrite your category edits.
        </Text>
      </View>
    </ScrollView>
  );
